...
class GrlxPage_Comic extends GrlxPage {
	...
	protected function formatComicParts() {
		if ( $this->pageInfo['blog_post'] ) {
			//* $this->styleMarkdown($this->pageInfo['blog_post']); **Commented out for formatting reasons** *//
		}
		if ( $this->pageInfo['transcript'] ) {
			//* $this->styleMarkdown($this->pageInfo['transcript']); **Commented out for formatting reasons** *//
		}
	}
